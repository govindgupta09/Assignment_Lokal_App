package com.govi.lokal.adapter
...
import com.govi.lokal.DescriptionActivity
import com.govi.lokal.R
...
class MyAdapter(private var context: Context, private var myData: ArrayList<Product>, private val onItemClick: (Product) -> Unit):
    ...
    /**
     * A MyViewHolder help to describes an item view and metadata about its place within the RecyclerView.
     */
     ...
     * created a new {ViewHolder} and initializes some fields to be used by RecyclerView.
     */
